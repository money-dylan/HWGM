...
Turn text rules: second person, the fireside narrator voice from the voice bible; mood cues [plain] [soft] [warm] [tense] [grand] [excited] [afraid] and speaker cues like [nell] [posy] [idris] [dumbledore] [lady] [rooke] [odette] [mum] [dad] [captain]... before quoted dialogue; ~150–250 words for an ordinary turn; end on the player's move. Never write the player's own words, thoughts or actions. Capitalise mechanic terms only where a rule is genuinely being named.
